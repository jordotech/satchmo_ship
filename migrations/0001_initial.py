...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'OrderPackageItem'
        db.delete_table('satchmo_ship_orderpackageitem')

        # Deleting model 'OrderPackage'
        db.delete_table('satchmo_ship_orderpackage')

        # Removing M2M table for field order_package_items on 'OrderPackage'
        db.delete_table(db.shorten_name('satchmo_ship_orderpackage_order_package_items'))
